...
public class Users {
	...
	public String toString() {
		return "Users [usersId=" + usersId + ", name=" + name + ", gender=" + gender + ", contactInfo=" + contactInfo
				...
				+ ", community=" + community + ", getUsersId()=" + getUsersId() + ", getName()=" + getName()
				+ ", getGender()=" + getGender() + ", getContactInfo()=" + getContactInfo()
				+ ", getEmergencyContactName()=" + getEmergencyContactName() + ", getEmergencyContactPhone()="
				+ getEmergencyContactPhone() + ", getEmergencyContactRelation()=" + getEmergencyContactRelation()
				+ ", getLineId()=" + getLineId() + ", getState()=" + getState() + ", getCreateAt()=" + getCreateAt()
				+ ", getLastAlterAt()=" + getLastAlterAt() + ", getPhoto()=" + getPhoto() + ", getEmail()=" + getEmail()
